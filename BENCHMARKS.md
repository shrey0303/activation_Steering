...
## Qwen2.5-0.5B (24 layers, hidden_dim=896) â‚¬" 6/25 significant
...
### Steering Results (5 Concepts Ãƒ-- 5 Strengths)

| Concept | Target Layer | Vector Mag | Best Strength | Best d | p-value | Sig? | Sig Count |
|---------|-------------|-----------|---------------|--------|---------|------|-----------|
| **Creativity** | 21 | 4.22 | **2.5** | **0.647** | **0.017** | **Å“â€¦** | **4/5** |
| **Verbosity** | 11 | 1.42 | **2.0** | **1.179** | **0.002** | **Å“â€¦** | **2/5** |
| Toxicity | 13 | 1.39 | 1.0 | 0.928 | 0.080 | ÂÅ’ | 0/5 |
| Politeness | 11 | 2.18 | 2.5 | 0.559 | 0.315 | ÂÅ’ | 0/5 |
| Refusal | 13 | 1.76 | 0.5 | 0.029 | 0.634 | ÂÅ’ | 0/5 |
...
| Effect Size (mean \|d\|) | 0.420 Â± 0.346 |
| Perplexity Ratio (mean) | 1.135 |
| Significant tests | 6/25 |
| Fluency Preserved | Å“â€¦ |
| All Pipeline Steps Pass | Å“â€¦ |

---

## Qwen2.5-7B (28 layers, hidden_dim=3584) â‚¬" 6/25 significant
...
| Concept | Target Layer | Vector Mag | Best Strength | Best d | p-value | Sig? | Sig Count |
|---------|-------------|-----------|---------------|--------|---------|------|-----------|
| **Creativity** | 19 | 39.72 | **2.0** | **1.236** | **0.003** | **Å“â€¦** | **4/5** |
| **Politeness** | 9 | 116.55 | **1.0** | **-1.258** | **0.016** | **Å“â€¦** | **2/5** |
| Toxicity | 21 | 82.32 | 2.0 | 0.440 | 0.333 | ÂÅ’ | 0/5 |
| Refusal | 21 | 185.29 | -0.242 | 0.530 | 0.429 | ÂÅ’ | 0/5 |
| Verbosity | 9 | 76.47 | 2.5 | 0.753 | 0.057 | ÂÅ’ | 0/5 |
