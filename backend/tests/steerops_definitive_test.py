...
from app.core.stats import compute_stats, paired_t_test, cohens_dz as cohens_d, validate_sweep_entry
...
# ------------------------------------------------------------
# compute_stats, paired_t_test, cohens_d imported from app.core.stats
